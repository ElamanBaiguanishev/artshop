        ...
        <div className="mx-auto grid max-w-[var(--container)] gap-10 px-5 py-16 md:grid-cols-[0.8fr_1fr] md:items-center md:gap-16 md:px-10 md:py-24">
          ...
          <div>
            ...
            <p className="mt-6 text-muted-foreground">
              Я живу в Петропавловске, пишу маслом и делаю украшения из эпоксидной смолы. Свет над
              степью держится сорок минут, и за это время нужно успеть главное — остальное дописываю
              в мастерской.
            </p>
            <Link
              href="/about"
