...
const REVIEWS = [
  ...
  },
  {
    author: 'Марина',
    city: 'Прага',
    text: 'Заказывала брелок с именем дочери в подарок. Алия прислала фото на каждом этапе, дошло за три недели.',
  },
  {
    author: 'Сергей',
    city: 'Алматы',
    text: 'Долго выбирал между двумя работами, Алия помогла примерить обе в интерьере по фото. Ни разу не пожалел.',
  },
];
        ...
        <div className="mx-auto grid max-w-[var(--container)] gap-10 px-5 py-16 md:grid-cols-[0.8fr_1fr] md:items-center md:gap-16 md:px-10 md:py-24">
          ...
          <div>
            ...
            <p className="mt-6 text-muted-foreground">
              Меня зовут Алия. Я живу в Петропавловске, пишу маслом и делаю украшения из эпоксидной
